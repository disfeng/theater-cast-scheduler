...
export type GrantBatchPayload = { source_type?: string; source_month: string | null; source_label: string; title: string | null; grant_date: string | null; default_expires_at: string | null; notes: string | null; items: GrantDraftItem[] };
