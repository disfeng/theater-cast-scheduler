const labels: Record<string, string> = { available: "可用", reserved: "已预留", consumed: "已核销", expired: "已过期", revoked: "已撤销", granted: "已发放", released: "已释放", extended: "已延期", restored: "已恢复", adjusted: "已调整" };
